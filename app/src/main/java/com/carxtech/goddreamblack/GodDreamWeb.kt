...
import com.carxtech.databinding.ActivityWebsBinding
...
import com.carxtech.goddreamblack.AppClassGodDream.Companion.AHHASHQHS
...
class GodDreamWeb : AppCompatActivity() {
    private val FILECHOOSERRESULTCODE = 1

    // the same for Android 5.0 methods only
    var odowodowdp: ValueCallback<Array<Uri>>? = null
    var xbbxcbgscgs: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vv.webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                odowodowdp?.onReceiveValue(null)
                odowodowdp = filePathCallback
                ...
                if (takePictureIntent!!.resolveActivity(packageManager) != null) {
                    ...
                    try {
                        ...
                        takePictureIntent.putExtra("PhotoPath", xbbxcbgscgs)
                    ...
                    if (photoFile != null) {
                        xbbxcbgscgs = "file:" + photoFile.absolutePath
        ...
        vv.loadUrl(dpofoeofowefo())
    }



    fun xjjshdhwhhdqdqwd(string: String){
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun dpofoeofowefo(): String {
        ...
        val cpOne: String? = sharPref.getString(AASQSQSQSQ, "null")
        val dpOne: String? = sharPref.getString(SPDPWPDOWOD, "null")
        val mainid: String? = sharPref.getString(AHHASHQHS, null)

        val pack = "com.carxtech"
        ...
        val first = "http://"
        val second = "godsofdream.xyz/go.php?to=2&"
        ...
        xjjshdhwhhdqdqwd(afId.toString())
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode != FILECHOOSERRESULTCODE || odowodowdp == null) {
        ...
        if (resultCode == AppCompatActivity.RESULT_OK) {
            if (data == null || data.data == null) {
                ...
                results = arrayOf(Uri.parse(xbbxcbgscgs))
            } else {
        ...
        odowodowdp?.onReceiveValue(results)
        odowodowdp = null
    }
